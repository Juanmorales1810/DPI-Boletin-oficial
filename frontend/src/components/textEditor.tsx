...
export default function TextEditor() {
    ...
    useEffect(() => {
        if (editorRef.current) {
            ...
            editorInstanceRef.current = new Editor({
                ...
                editorProps: {
                    attributes: {
                        class: "prose prose-lg font-[family-name:var(--font-ubuntu)] max-w-none",
                    },
                },
                onUpdate: ({ editor }) => {
    ...
    const handleFinalizarPago = () => {
        // Guardar el contenido del editor en el estado global si es necesario
        const contenidoHTML = editorInstanceRef.current?.getHTML();

        // Preparar los datos para enviar a la página de pago
        const params = new URLSearchParams({
            wordCount: count.toString(),
            pricePerWord: "8",
            totalAmount: (count * 8).toString(),
            // Si necesitas enviar el contenido HTML, puedes codificarlo
            contenido: encodeURIComponent(contenidoHTML || ""),
        }).toString();

        // Redireccionar a la página de pago
        router.push(`/cargar-boletin/completar-boletin/checkout?${params}`);
    };
                ...
                <div className="flex flex-col justify-center items-center w-full">
                                        ...
                                        <DropdownMenu>
                                            ...
                                            <DropdownMenuContent>
                                                ...
                                                >
                                                    <p
                                                        data-text-size="16px"
                                                        className="flex justify-between items-center w-full text-base rounded px-3 py-2 hover:bg-zinc-100 text-zinc-900 dark:hover:bg-zinc-600 dark:text-white"
                                                    >
                                                        16px (Default)
                                                    </p>
                                                </DropdownMenuItem>
                                                ...
                                                >
                                                    <p
                                                        data-text-size="12px"
                                                        className="flex justify-between items-center w-full text-xs rounded px-3 py-2 hover:bg-zinc-100 text-zinc-900 dark:hover:bg-zinc-600 dark:text-white"
                                                    >
                                                        12px (Tiny)
                                                    </p>
                                                </DropdownMenuItem>
                                                ...
                                                >
                                                    <p
                                                        data-text-size="14px"
                                                        className="flex justify-between items-center w-full text-sm rounded px-3 py-2 hover:bg-zinc-100 text-zinc-900 dark:hover:bg-zinc-600 dark:text-white"
                                                    >
                                                        14px (Small)
                                                    </p>
                                                </DropdownMenuItem>
                                                ...
                                                >
                                                    <p
                                                        data-text-size="18px"
                                                        className="flex justify-between items-center w-full text-lg rounded px-3 py-2 hover:bg-zinc-100 text-zinc-900 dark:hover:bg-zinc-600 dark:text-white"
                                                    >
                                                        18px (Lead)
                                                    </p>
                                                </DropdownMenuItem>
                                                ...
                                                >
                                                    <p
                                                        data-text-size="24px"
                                                        className="flex justify-between items-center w-full text-2xl rounded px-3 py-2 hover:bg-zinc-100 text-zinc-900 dark:hover:bg-zinc-600 dark:text-white"
                                                    >
                                                        24px (Large)
                                                    </p>
                                                </DropdownMenuItem>
                                                ...
                                                >
                                                    <p
                                                        data-text-size="36px"
                                                        className="flex justify-between items-center w-full text-4xl rounded px-3 py-2 hover:bg-zinc-100 text-zinc-900 dark:hover:bg-zinc-600 dark:text-white"
                                                    >
                                                        36px (Huge)
                                                    </p>
                                                </DropdownMenuItem>
                    ...
                    <div className="w-full px-4 py-2 bg-white rounded-b-lg min-h-96 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-800 shadow-xl dark:shadow-none">
                        <div
                            ref={editorRef}
                            id="wysiwyg-example"
                            className="block w-full px-0 text-zinc-800 bg-white border-0 dark:bg-zinc-800 focus:ring-0 dark:text-white dark:placeholder-zinc-400 max-w-5xl"
                        ></div>
                    </div>
                </div>
            </div>
            <div className="flex flex-col justify-center items-center w-full max-w-lg bg-white rounded-lg space-y-4 my-6 px-8 py-6 sticky top-20 shadow-md">
                ...
                <div className="flex justify-between items-center gap-4 w-full max-w-72">
                    <button
                        ...
                        className="bg-gris80 text-white py-2 px-6 rounded-md flex justify-center items-center gap-2 flex-1"
                    >
                        <CompraIcon />
                        Pagar
                    </button>
                    <p className="py-2 px-6 bg-gris50 rounded-md text-gris80 text-nowrap">
                        Valor: ${count * 8}
                    </p>
                </div>
            </div>
